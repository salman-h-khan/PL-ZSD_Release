...
def main(args=None):
    ...
    if args.snapshot is not None:
        ...
        training_model = retinanet_vocab_w2v.retinanet_bbox(inputs=inputs, num_classes=65, backbone=resnet)
        # compile model
        training_model.compile(
            loss={
                'regression'    : losses.smooth_l1(),
    ...
    cocomodel65 = retinanet.retinanet_bbox(inputs=inputs, num_classes=65, backbone=cocomodel_resnet)
